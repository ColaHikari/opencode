...
export const dict = {
  ...
  "dialog.workflow.action.save.unavailable": "Als Befehl speichern (nur Desktop-CLI)",
  ...
  "toast.workflow.save.unavailable.title": "Speichern hier nicht verfügbar",
  "toast.workflow.save.unavailable.description":
    "Eine Ausführung als Befehl zu speichern erfordert die Desktop-CLI; das ist ein Folgeschritt für die Web-App.",
