...
export const dict = {
  ...
  "command.ultracode.enable": "Ultracode: einschalten",
  ...
  "command.workflow.dashboard": "Workflows öffnen",

  "dialog.workflow.title": "Workflows",
  "dialog.workflow.description": "{{count}} Ausführungen",
  "dialog.workflow.empty": "Noch keine Workflow-Ausführungen. Starte eine mit /workflow <name>.",
  "dialog.workflow.section.phases": "Phasen",
  "dialog.workflow.section.agents": "Agenten",
  "dialog.workflow.section.result": "Ergebnis",
  "dialog.workflow.section.usage": "Verbrauch",
  "dialog.workflow.section.logs": "Protokoll",
  "dialog.workflow.logs.earlier": "… {{count}} ältere Einträge",
  "dialog.workflow.status.running": "läuft",
  "dialog.workflow.status.completed": "abgeschlossen",
  "dialog.workflow.status.failed": "fehlgeschlagen",
  "dialog.workflow.status.cancelled": "abgebrochen",
  "dialog.workflow.status.interrupted": "unterbrochen",
  "dialog.workflow.status.paused": "pausiert",
  "dialog.workflow.action.pause": "Pausieren",
  "dialog.workflow.action.resume": "Fortsetzen",
  ...
  "dialog.workflow.usage.total": "Gesamtkosten: ${{cost}}",
  "dialog.workflow.detail.empty": "Wähle eine Ausführung, um Details zu sehen.",
  "dialog.workflow.detail.noResult": "Noch kein Ergebnis.",
  "dialog.workflow.detail.noAgents": "Es wurden noch keine Agenten ausgeführt.",

  "dialog.workflow.question.title": "Workflow-Frage",
  "dialog.workflow.question.placeholder": "Antwort eingeben…",

  "dialog.workflow.approval.title": "Workflow starten: {{name}}",
  "dialog.workflow.approval.whenToUse": "Wann verwenden: {{text}}",
  "dialog.workflow.approval.arguments": "Argumente",
  "dialog.workflow.approval.noPhases": "(keine deklariert)",
  "dialog.workflow.approval.noSource": "Kein Quelltext gespeichert.",
  "dialog.workflow.approval.view": "Skript ansehen",
  "dialog.workflow.approval.back": "Zurück zur Freigabe",
  "dialog.workflow.approval.yes": "Ja",
  "dialog.workflow.approval.always": "Ja, immer",
  ...
  "toast.workflow.save.ok.title": "Workflow gespeichert",
  "toast.workflow.save.ok.description": "{{name}} als Befehl gespeichert.",
  "toast.workflow.save.conflict.title": "Workflow existiert bereits",
