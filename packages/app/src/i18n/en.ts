export const dict = {
  ...
  "dialog.workflow.action.save.unavailable": "Save as command (desktop CLI only)",
  ...
  "toast.workflow.save.unavailable.title": "Save not available here",
  "toast.workflow.save.unavailable.description":
    "Saving a run as a command needs the desktop CLI; this is a follow-up for the web app.",
}
